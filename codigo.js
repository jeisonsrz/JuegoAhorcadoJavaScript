...
window.onload = function(){
	 ...
	 var juego = function(){
		var letra = ["Hola","Perdo","Juan","Camino","Asalto","Comida","Carga","pintura","agua","fuego","tierra","crema","azul","cielo","tecla","silla","perro","gato","salsa","automovil","carro",
		"lora", "libro", "bus", "pantalla", "aereonave", "hola", "pajaro","salida", "marcador", "lapiz", "traje", "bruja", "mejorando", "trampa", "ahorcado", "reloj", "programa", "tinta", "balanza",
		"juego", "peluche", "sandia", "melon", "uvas", "musica","Nicaragua", "abanico", "consola", "ropa", "sapo", "aves", "pelota","caramelo", "estuche", "zapato", "caballo", "camilla", "enfermero",
		"tonto", "juego", "comida", "manzana", "animal", "clave","sirena", "corazon", "pasado", "muerte","coche", "mano", "pie", "pastel", "pasta", "puerta", "edificio"];
		var rnd, largo;
	...
	function dibujarCuerpo(i){
		...
		if (i >= 6) {
			trazo.drawImage(cabezamuerta,90,90);
